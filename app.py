...
app.config["SESSION_COOKIE_SECURE"] = True  # Secure because Railway provides HTTPS
...
def save_history():
    ...
    try:
        ...
        return jsonify({"message": "Saved successfully", "id": history_id}), 201
    except Exception as e:
        return jsonify({"error": str(e)}), 500
    finally:
        if cursor:
